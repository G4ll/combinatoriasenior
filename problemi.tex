...
\Problema{IMOSL}{2018}{1}
{'costruttivo'}
{C'è da costruire un insieme con certe proprietà, ma si fa un po' a caso.}

\Problema{IMOSL}{2018}{2}
{'nonesistenza', 'invarianti', 'colorazioni', 'gioco', 'tabelle'}
{Serve una colorazione per scegliere la strategia e una più fine per mostarre che funziona.}

\Problema{IMOSL}{2018}{3}
{'nonesistenza', 'invarianti'}
{L'invariante è praticamente già contenuto nel testo.}

\Problema{IMOSL}{2018}{4}
{'nonesistenza', 'conteggi'}
{Conto un po' a naso.}

\Problema{IMOSL}{2018}{5}
{'algoritmi', 'conteggi', 'grafi'}
{L'algoritmo che funziona è una coda.}
